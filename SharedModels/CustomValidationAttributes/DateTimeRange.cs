...
namespace Entities.CustomValidationAttributes
{
    public class DateTimeRange : ValidationAttribute
    {
        ...
        public DateTimeRange(string minDate, string? maxDate = null)
        {
            ...
            if(maxDate == null) { _maxDate = DateTime.Now; }
        ...
        protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
        {
            if (value is DateTime dateTime)
            {
                ...
                return new ValidationResult($"The date must be between {_minDate.ToShortDateString()} and {DateTime.Now.ToShortDateString()}.");
            }
